...
void generate_data(double seed, int N, int T)
{
  ...
  cout<<"Eigen values of D are \n"<<eig_D;

  cout<<"Eigen vectors of D are \n"<<eig_vec_D;
  ...
  cout<<"Eigen values of u_D are \n"<<u_eig_D;

  cout<<"Eigen vectors of u_D are \n"<<u_eig_vec_D;
  ...
  cout<<"The eigen values of u_C are \n "<<u_eig_C;
...
int main()
{
  ...
  int N=10;//N is the dimension of N*N matrix.
  int T=2;
